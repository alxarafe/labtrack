...
<div class="container-fluid px-4">
    ...
    <form action="{{ $me::url('saveCenters') }}" method="POST">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0" id="centersTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <input type="text" name="id[]" class="form-control text-center" value="{{ $center->id }}" readonly>
                                </td>
                                <td>
                                    <input type="number" name="sort_order[]" class="form-control text-center" value="{{ $center->sort_order }}" required>
                                </td>
                                <td>
                                    <input type="text" name="name[]" class="form-control" value="{{ $center->name }}" required>
                                </td>
                                <td>
                                    <input type="text" name="button_text[]" class="form-control" value="{{ $center->button_text }}" placeholder="{{ $center->name }}">
                                </td>
                                <td class="text-center">
                                    <div class="form-check form-check-inline text-danger">
                                        <input class="form-check-input border-danger" type="checkbox" name="off[]" value="1" {{ !$center->active ? 'checked' : '' }}>
                                    </div>
                                </td>
                                <td>
