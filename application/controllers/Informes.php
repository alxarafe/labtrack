...
class Informes extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->data['title'] = 'Informes';
        $this->data['description'] = 'Informes';
        $this->data['keywords'] = '';

        $this->load->model(array('users_model', 'protesis_model'));
    ...
    public function index()
    {
        ...
        $this->load->view('informes/' . $page, $this->data);
    ...
    public function usuario()
    {
        ...
        $desde = strtotime(isset($_POST['fechadesde']) ? $_POST['fechadesde'] : date('Y-m-d', strtotime("-1 month")));
        $hasta = strtotime(isset($_POST['fechahasta']) ? $_POST['fechahasta'] : date('Y-m-d', strtotime("now")));
        ...
        $this->data['fechadesde'] = date('Y-m-d', $desde);
        $this->data['fechahasta'] = date('Y-m-d', $hasta);

        if (isset($_POST['aceptar'])) {
            $this->data['informe'] = $this->protesis_model->get_user_report($user, $this->data['fechadesde'], $this->data['fechahasta']);
        }
    ...
    public function exportar($user, $desde, $hasta)
    {
        ...
        echo "<p>Fichero <a href='" . base_url($fichero) . "'>generado</a></p>";
    }
    ...
    public function orden()
    {
        ...
        if (isset($_POST['aceptar'])) {
            $this->data['informe'] = $this->protesis_model->get_movimientos_detallados($_POST['orden']);
        }
