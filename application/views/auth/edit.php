...
*/ ?>
    ...
    <div class="form-group">
        ...
        <?= form_label('Acceso rápido', 'fastaccess', array('class' => 'col-lg-2 control-label')); ?>
        <div class="col-lg-10">
            <?= form_error('fastaccess') ?>
            <?= form_input(
                array(
                    'type' => 'number',
                    'name' => 'fastaccess',
                    ...
                    'value' => (set_value('fastaccess') ? set_value('fastaccess') : (set_value('fastaccess') ? set_value('fastaccess') : (isset($fastaccess) ? $fastaccess : $user['fastaccess']))),
                    'min' => 0,
                    'max' => 9999999999999,
                    'class' => 'form-control')
            ); ?>
...
<div class="social-wall">
	<h4>
	Añada una nueva red social
	<a class="label label-primary" href="<?= site_url("auth/slogin/Facebook") ?>">Facebook</a>
	<a class="label label-info" href="<?= site_url("auth/slogin/Twitter") ?>">Twitter</a>
	<a class="label label-danger" href="<?= site_url("auth/slogin/Google") ?>">Google+</a>
	<a class="label label-primary" href="<?= site_url("auth/slogin/LinkedIn") ?>">LinkedIn</a>
	</h4>
</div>
*/ ?>
