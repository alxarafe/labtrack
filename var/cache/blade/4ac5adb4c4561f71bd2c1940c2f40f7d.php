...
<div class="container-fluid px-4">
    <div class="row mb-4">
        <div class="col">
            <h1 class="display-6 fw-bold"><i class="fas fa-cogs me-2"></i><?php echo e($title); ?></h1>
        </div>
    </div>

    <form action="/configuracion/procesos/save" method="POST">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0" id="processesTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <input type="text" name="id[]" class="form-control text-center" value="<?php echo e($process->id); ?>" readonly>
                                </td>
                                <td>
                                    <input type="number" name="sort_order[]" class="form-control text-center" value="<?php echo e($process->sort_order); ?>" required>
                                </td>
                                <td>
                                    <a href="/configuracion/procesos/<?php echo e($process->id); ?>" class="btn btn-outline-primary btn-sm w-100">
                                        <i class="fas fa-tags me-1"></i>Familias
                                    </a>
                                </td>
                                <td>
                                    <input type="text" name="name[]" class="form-control" value="<?php echo e($process->name); ?>" required>
                                </td>
                                <td>
                                    <input type="text" name="button_text[]" class="form-control" value="<?php echo e($process->button_text); ?>" placeholder="<?php echo e($process->name); ?>">
                                </td>
                                <td class="text-center">
                                    <div class="form-check form-check-inline text-danger">
                                        <input class="form-check-input border-danger" type="checkbox" name="off[]" value="1" <?php echo e(!$process->active ? 'checked' : ''); ?>>
                                    </div>
                                </td>
                                <td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/templates/labtrack/config/processes.blade.php ENDPATH**/ ?>