...
function addusr() {
    ...
    row.innerHTML =
        '<td><input id="oldid' + i + '" name="oldid[' + i + ']" value="0" hidden />0</td>' +
        '<td><input id="id' + i + '" name="id[' + i + ']" value="' + i + '" /></td>' +
        '<td><input id="nombre' + i + '" name="nombre[' + i + ']" value="" /></td>' +
        '<!-- <td><input id="fastaccess' + i + '" name="fastaccess[' + i + ']" value="" /></td> -->' +
        '<td><input id="admin' + i + '" type="checkbox" name="admin[' + i + ']"> Administrador</input></td>' +
        '<td><input id="supervisor<' + i + '" type="checkbox" name="supervisor[' + i + ']"> Supervisor</input></td>' +
        '<td><input id="check' + i + '" type="checkbox" name="off[' + i + '" onClick="checkcc(' + i + ');"> Desactivado</input></td>';
    return false;
}
...
function addcc() {
    ...
    row.innerHTML =
        ...
        '<td><input id="orden' + i + '" type="number" name="orden[' + i + ']" value="0" /></td>' +
        '<td><input id="nombre' + i + '" name="nombre[' + i + ']" value="" /></td>' +
        '<td><input id="boton' + i + '" name="nombre_boton[' + i + ']" value="" /></td>' +
        '<td><input id="check' + i + '" type="checkbox" name="off[' + i + '" onClick="checkcc(' + i + ');"> Desactivado</input></td>';
    return false;
}

function addfam() {
    x = document.getElementById("centro0");
    ...
    row.innerHTML =
        '<td><input id="id' + i + '" name="id[' + i + ']" value="' + i + '" hidden />' + i + '</td>' +
        '<td><input id="orden' + i + '" type="number" name="orden[' + i + ']" /></td>' +
        '<td><select id="centro' + i + '" name="centro[' + i + ']" class="selectpicker" value="0">' + x.innerHTML + '</select></td>' +
        '<td><input id="nombre' + i + '" name="nombre[' + i + ']" value="" /></td>' +
        '<td><input id="boton' + i + '" name="nombre_boton[' + i + ']" value="" /></td>' +
        '<td><input id="check' + i + '" type="checkbox" name="off[' + i + '" onClick="checkcc(' + i + ');"> Desactivado</input></td>';

    x = document.getElementById("centro" + i);
    x.selectedIndex = 0;
...
function addsec() {
    ...
    row.innerHTML =
        ...
        '<td><input id="nombre' + i + '" name="nombre[' + i + ']" value="" /></td>' +
        '<td><input id="boton' + i + '" name="nombre_boton[' + i + ']" value="" /></td>' +
        '<td><input id="duracion' + i + '" type="number" name="duracion[' + i + ']" value="0" /></td>' +
        '<td><input id="editable' + i + '" type="checkbox" name="editable[' + i + ']" onClick="checkactive(' + i + ');"/> Editable</input></td>' +
        '<td><input id="check' + i + '" type="checkbox" name="off[' + i + '" onClick="checkcc(' + i + ');"> Desactivado</input></td>';
    return false;
}

function checkactive(index) {
    row = document.getElementById("fila" + index);
    check = $("#check" + index);
    if (check.is(":checked")) {
