...
\Modules\LabTrack\Application\AppContainer::get();
...
Router::add('reports_user', '/reports/user', 'LabTrack.Report.operator');
...
Router::add('reports_export', '/reports/export', 'LabTrack.Report.export');
